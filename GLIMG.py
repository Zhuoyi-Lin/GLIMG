...
test_qrel_file = "~/testyelp.qrels"
#Load data for yelp dataset
dataset = np.loadtxt("C:/Users/ZHUOYI001/Desktop/Past pub/RecSys19/support materials/dataset/yelp/yelp_train.txt")
...
#rank_list_file = "~/test.ranklist"
#test_qrel_file = "~/testml1m.qrels"
#dataset = np.loadtxt("~/support materials/dataset/ml1m/ml1m_train.txt")
#num_users=int(dataset[:,0].max()+1);
#num_items=int(dataset[:,1].max()+1);            
#
#mat_train = sp.lil_matrix((num_users, num_items), dtype=np.int)
